...
```
# 添加 label
kubectl label nodes-1 mongo="true"
# 删除 label
kubectl label node-s mongo-
```
...
rs.initiate({
        ...
        members: [
             { _id: 0, host : "mongo-rs-0.mongo-rs-svc:27017" },
	           { _id: 1, host : "mongo-rs-0.mongo-rs-svc:27017" },
	           { _id: 2, host : "mongo-rs-0.mongo-rs-svc:27017" },
 ]});
...
rs.reconfig({_id: "rs",
        ...
        members: [
            { _id: 0, host : "mongo-rs-0.mongo-rs-svc:27017" },
            { _id: 1, host : "mongo-rs-0.mongo-rs-svc:27017" },
            { _id: 2, host : "mongo-rs-0.mongo-rs-svc:27017" }, {"force":true});
