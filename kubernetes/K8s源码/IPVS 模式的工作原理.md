## 这一次，彻底搞懂 kube-proxy IPVS 模式的工作原理！

>
>
>**作者**：Dustin Specker
>**译者**：米开朗基杨
>**译者简介**：KubeSphere 布道师，目前就职于青云科技 KubeSphere 团队，是一名云原生技术爱好者，专注于 Kubernetes 与 KubeSphere 等云原生技术干货分享，你可以通过微信与我联系，我的微信号是 cloud-native-yang，欢迎前来围观我的朋友圈
>
>
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/qFG6mghhA4ZjgRL1R4b5jAUwQysTkmpf2zm8KUFMZOzLWXWPoUSWGsJMPPnVicVvBL7Fk7Rl2eBcXFXdzrCYZLg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/qFG6mghhA4ZjgRL1R4b5jAUwQysTkmpf0hvQHNLDhtm1Wvtbv5Zba1seFs9ic2HqlhCgNKUbntlQV1OTvNhjISg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/qFG6mghhA4ZjgRL1R4b5jAUwQysTkmpfJUL2xVjRFruIhkTjaSFsJicfX3CyRw6uNZKRYYEaz4rcibU7oETKdosA/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
2. 如果 DNAT 后是转发到了同节点上的 Pod，目的 Pod 回包时发现目的 IP 在同一网桥上，就直接走二层转发了，没有调用 conntrack，导致回包时没有原路返回 (见下图)。
   ...
   ![图片](https://mmbiz.qpic.cn/mmbiz_png/qFG6mghhA4ZjgRL1R4b5jAUwQysTkmpfRJZXVEYEEyp4GmibTOFh38DuqYlDr9xxjy7TImALlvycplMWAauQEvg/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/qFG6mghhA4ZjgRL1R4b5jAUwQysTkmpf53ibrzYtn2HegqxlmjToWKwmLFV80m17TVmfIROklWOQLX1MNr1wj5A/640?wx_fmt=png&wxfrom=5&wx_lazy=1&wx_co=1)
...
原文链接：**https://dustinspecker.com/posts/ipvs-how-kubernetes-s**